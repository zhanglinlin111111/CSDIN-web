...
final class Settings {
	...
	public function __construct() {
		...
		$options       = get_option( $this->options_key, wp_json_encode( $this->settings_schema ) );
	...
	public function update( $value ) {
		...
		$update = update_option( $this->options_key, wp_json_encode( $this->options ), false );
	...
	public function reset() {
		$update = update_option( $this->options_key, wp_json_encode( $this->settings_schema ) );
		if ( $update ) {
