 ...
 * @since 1.0.0
 */
class Widget_Image_Zendkee extends Widget_Base
{
    ...
    {
        return __('Image 2in1', 'elementor');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'image',
            [
                'label' => __('Choose Image - PC', 'elementor'),
