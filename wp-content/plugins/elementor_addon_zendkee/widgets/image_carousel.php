 ...
 * @since 1.0.0
 */
class Widget_Image_Carousel_Zendkee extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Image Carousel 2in1', 'elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'carousel',
            [
                'label' => __( 'Images for Mobile', 'elementor' ),
    ...
    protected function render() {
        ...
        foreach ( $settings['carousel'] as $index => $attachment ) {
            ...
            $mobile_image_url = isset($settings['carousel_mobile'][$index]) ? Group_Control_Image_Size::get_attachment_image_src( $settings['carousel_mobile'][$index]['id'], 'thumbnail', $settings ) : '';

//            $image_html = '<img class="swiper-slide-image" src="' . esc_attr( $image_url ) . '" alt="' . esc_attr( Control_Media::get_image_alt( $attachment ) ) . '" />';
            $image_html = '<img src="'.ELEMENT_ADDON_ZENDKEE_URL.'libs/image/placeholder.png" class="swiper-slide-image img-zendkee-elementor-image" data-pc-image-url="' . esc_attr( $image_url ) . '" data-mobile-image-url="' . esc_attr( $mobile_image_url ) . '" alt="' . esc_attr( Control_Media::get_image_alt( $attachment ) ) . '" />';
//            $image_html = '<img  class="swiper-slide-image img-zendkee-elementor-image" data-pc-image-url="' . esc_attr( $image_url ) . '" data-mobile-image-url="' . esc_attr( $mobile_image_url ) . '" alt="' . esc_attr( Control_Media::get_image_alt( $attachment ) ) . '" />';
