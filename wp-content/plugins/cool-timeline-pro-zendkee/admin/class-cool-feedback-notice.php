...
if (!class_exists('CoolFeedbackNotice')) {
    class CoolFeedbackNotice {
        /**
         * The Constructor
         */
    ...
    public function admin_notice_for_reviews(){
       ...
       function create_notice_content(){
        ...
        $p_link=esc_url('https://codecanyon.net/item/cool-timeline-pro-wordpress-timeline-plugin/reviews/17046256');
