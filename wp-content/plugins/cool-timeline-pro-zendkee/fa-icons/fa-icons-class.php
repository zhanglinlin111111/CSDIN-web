...
if (!class_exists('Ctl_Fa_Icons')) {
    ...
    class Ctl_Fa_Icons
    {
        ...
        {
            if('cool_timeline' != get_post_type()){
                return;
            }
            ?>
        ...
        public function ctl_ss()
        {
            ...
            if (in_array(get_current_screen()->post_type, $this->screens)) {
                ...
                wp_enqueue_style('fa-field-fontawesome-css', CTP_FA_URL . 'css/font-awesome/css/all.min.css');
        ...
        private function ctl_generate_icon_array()
        {
            ...
            if (!$icons) {
                $all_icons = json_decode(file_get_contents(CTP_FA_DIR . 'fontawesome-5.json'), true);
